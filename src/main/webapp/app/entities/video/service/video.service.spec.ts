...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../video.test-samples';

import { RestVideo, VideoService } from './video.service';

const requireRestSample: RestVideo = {
  ...sampleWithRequiredData,
  fechaCreacion: sampleWithRequiredData.fechaCreacion?.toJSON(),
  fechaDescarga: sampleWithRequiredData.fechaDescarga?.toJSON(),
};
  ...
  describe('Service methods', () => {
    ...
    describe('addVideoToCollectionIfMissing', () => {
      it('should add a Video to an empty array', () => {
        ...
        expect(expectedResult).toEqual([video]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([video, video2]);
      });
