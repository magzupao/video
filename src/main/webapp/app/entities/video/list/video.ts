...
import { VideoDeleteDialog } from '../delete/video-delete-dialog';
...
export class Video implements OnInit {
  ...
  trackId = (item: IVideo): number => this.videoService.getVideoIdentifier(item);
  ...
  delete(video: IVideo): void {
    const modalRef = this.modalService.open(VideoDeleteDialog, { size: 'lg', backdrop: 'static' });
