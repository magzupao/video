...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.video.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.video.app.security.DomainUserDetailsService", "createSpringSecurityUser");
